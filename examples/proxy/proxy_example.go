...
func proxy(w http.ResponseWriter, r *http.Request) {
	...
	// Set Widevine portal options and create instance.
	...
	licenseOptions := widevine.LicenseOptions{
		Body: body, // Base64 string of license generated by CDM.
	}
	data := wv.GetLicense(licenseOptions)
